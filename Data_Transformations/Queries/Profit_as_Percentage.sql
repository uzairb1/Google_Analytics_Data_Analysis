select (t1.Subscribed-t2.Unsubscribed)/(select sum(monthly_total_spend)from `my-project-1535534415901.formel_Uzi.formel_marketing`)*100 as Profit_Percentage, 
